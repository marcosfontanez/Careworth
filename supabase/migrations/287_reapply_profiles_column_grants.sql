-- ============================================================
-- Re-apply profiles column grants after onboarding columns
-- Reconciled from WIP migrations-parked/wip-253-278 (Phase 3)
-- ============================================================

-- ---------- source: 256_reapply_profiles_column_grants.sql ----------
-- ============================================================
...
-- not included â†’ authenticated REST reads that select them fail with
