-- =============================================================================
-- 136: Allow staff to grant shop borders to their own account (QA / demos).
-- Previously economy_admin_grant_shop_item raised not_allowed when recipient
-- equaled auth.uid(), which made “gift myself” from Shop Catalog admin fail
...
comment on function public.economy_admin_grant_shop_item(uuid, uuid, text, text) is
  ...
  '(recipient accepts via economy_accept_pending_border_gift). Self-grant allowed for staff QA.';
