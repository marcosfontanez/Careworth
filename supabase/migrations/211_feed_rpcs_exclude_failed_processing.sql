...
-- also hide posts where media processing failed (broken clip/stitch placeholders).
...
-- get_ranked_feed / get_ranked_feed_v2: same filter patch (see migration 160 for full bodies).
-- Only the media_processing_status predicate changes here.
...
-- v2 body unchanged except failed exclusion (copied from 160 + patch).
