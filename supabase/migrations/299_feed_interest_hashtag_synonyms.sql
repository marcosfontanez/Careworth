-- ============================================================
-- Feed interest hashtag synonyms
-- Reconciled from WIP migrations-parked/wip-253-278 (Phase 3)
-- ============================================================

-- ---------- source: 255_feed_interest_hashtag_synonyms.sql ----------
-- ============================================================================
-- 255: Feed ranker v3 â€” expand onboarding interest cold-start via hashtag synonyms
--
