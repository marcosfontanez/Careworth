...
export const mockCircles: CircleAdmin[] = [
  ...
  },
  {
    ...
    name: "Pharmacy",
    slug: "pharmacy",
    description: "Pharmacy professionals",
    icon: "💊",
    accentColor: "#10B981",
    categories: ["Healthcare"],
    members: 5400,
