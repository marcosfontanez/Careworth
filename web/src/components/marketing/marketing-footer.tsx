  ...
  return (
    <footer className="border-t border-[rgba(148,163,184,0.1)] bg-pv-navy-deep">
      <div className={cn(marketingGutterX, "py-10 sm:py-14")}>
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-6 text-center text-sm text-muted-foreground sm:flex-row sm:text-left">
