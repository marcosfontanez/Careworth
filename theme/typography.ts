...
export const typography: Record<string, TextStyle> = {
  h1: { fontSize: 28, fontWeight: '800', letterSpacing: -0.55 },
  h2: { fontSize: 22, fontWeight: '800', letterSpacing: -0.35 },
  ...
  screenTitle: { fontSize: 26, fontWeight: '900', letterSpacing: -0.45 },
  ...
  sectionTitle: { fontSize: 16, fontWeight: '800', letterSpacing: -0.25 },
  /** Feed / card section labels */
  sectionLabel: { fontSize: 13, fontWeight: '700', letterSpacing: -0.12 },
  ...
  /** Uppercase micro labels — restrained tracking for premium calm */
